# DataAI ETL for Google Cloud Marketplace
...
This directory is the Google Cloud Marketplace review, packaging, and controlled-evaluation kit for the DataAI Spark libraries. DataAI remains embedded software that runs inside customer-controlled compute. It is not a required hosted service.
...
The repository-root `DataAIETLGoogle.zip` is the provider-review ZIP. Its sidecar is `DataAIETLGoogle.zip.sha256`.
