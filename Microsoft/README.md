# DataAI ETL for Microsoft Marketplace
...
This directory is the Microsoft Marketplace review, packaging, and controlled-evaluation kit for the DataAI Spark libraries. DataAI remains embedded software that runs inside customer-controlled compute. It is not a required hosted service.
...
The repository-root `DataAIETLMicrosoft.zip` is the provider-review ZIP. Its sidecar is `DataAIETLMicrosoft.zip.sha256`.
