# DataAI ETL for AWS Marketplace
...
This directory is the AWS Marketplace review, packaging, and controlled-evaluation kit for the DataAI Spark libraries. DataAI remains embedded software that runs inside customer-controlled compute. It is not a required hosted service.
...
The repository-root `DataAIETLAWS.zip` is the provider-review ZIP. Its sidecar is `DataAIETLAWS.zip.sha256`.
